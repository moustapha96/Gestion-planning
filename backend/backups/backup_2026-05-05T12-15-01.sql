...
\restrict D6ufcIhVL2rrn6atSYXw3osdCCuEv2Ph60OpSy34JTPmSutAKcPa0Sacq7TmZTv
...
ALTER TABLE IF EXISTS ONLY public."User" DROP CONSTRAINT IF EXISTS "User_projectId_fkey";
...
ALTER TABLE IF EXISTS ONLY public."ProjectMessage" DROP CONSTRAINT IF EXISTS "ProjectMessage_senderId_fkey";
ALTER TABLE IF EXISTS ONLY public."ProjectMessage" DROP CONSTRAINT IF EXISTS "ProjectMessage_projectId_fkey";
ALTER TABLE IF EXISTS ONLY public."ProjectMessage" DROP CONSTRAINT IF EXISTS "ProjectMessage_parentId_fkey";
...
ALTER TABLE IF EXISTS ONLY public."ProjectDiscussion" DROP CONSTRAINT IF EXISTS "ProjectDiscussion_projectId_fkey";
ALTER TABLE IF EXISTS ONLY public."ProjectDiscussionMember" DROP CONSTRAINT IF EXISTS "ProjectDiscussionMember_userId_fkey";
ALTER TABLE IF EXISTS ONLY public."ProjectDiscussionMember" DROP CONSTRAINT IF EXISTS "ProjectDiscussionMember_discussionId_fkey";
...
DROP INDEX IF EXISTS public."User_projectId_idx";
...
DROP INDEX IF EXISTS public."ProjectMessage_senderId_createdAt_idx";
DROP INDEX IF EXISTS public."ProjectMessage_projectId_createdAt_idx";
DROP INDEX IF EXISTS public."ProjectMessage_parentId_idx";
DROP INDEX IF EXISTS public."ProjectFile_projectId_createdAt_idx";
DROP INDEX IF EXISTS public."ProjectDiscussion_projectId_key";
DROP INDEX IF EXISTS public."ProjectDiscussionMember_userId_joinedAt_idx";
DROP INDEX IF EXISTS public."ProjectDiscussionMember_discussionId_userId_key";
...
ALTER TABLE IF EXISTS ONLY public."ProjectMessage" DROP CONSTRAINT IF EXISTS "ProjectMessage_pkey";
ALTER TABLE IF EXISTS ONLY public."ProjectFile" DROP CONSTRAINT IF EXISTS "ProjectFile_pkey";
ALTER TABLE IF EXISTS ONLY public."ProjectDiscussion" DROP CONSTRAINT IF EXISTS "ProjectDiscussion_pkey";
ALTER TABLE IF EXISTS ONLY public."ProjectDiscussionMember" DROP CONSTRAINT IF EXISTS "ProjectDiscussionMember_pkey";
...
DROP TABLE IF EXISTS public."ProjectMessage";
DROP TABLE IF EXISTS public."ProjectFile";
DROP TABLE IF EXISTS public."ProjectDiscussionMember";
DROP TABLE IF EXISTS public."ProjectDiscussion";
...
--
-- Name: ProjectDiscussion; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public."ProjectDiscussion" (
    id text NOT NULL,
...
--
-- Name: ProjectDiscussionMember; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public."ProjectDiscussionMember" (
    id text NOT NULL,
    "discussionId" text NOT NULL,
    "userId" text NOT NULL,
    "joinedAt" timestamp(3) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL
...
--
-- Name: ProjectMessage; Type: TABLE; Schema: public; Owner: -
--
...
cmon1lxmb000iitqpn0lmtsqz	cmmo3suxw0000p1np0eron6et	BACKUP_RESTORE_DONE	Backup	cmon1g48u0005itqprqzw7e56	::1	Restauration terminée backup_2026-05-01T14-58-59.sql	2026-05-01 15:03:31.187
cmongont500031vuoe86hz3eb	cmmo3suxw0000p1np0eron6et	LOGIN	User	cmmo3suxw0000p1np0eron6et	::1	Connexion de admin@example.com	2026-05-01 22:05:32.681
cmongotav00071vuot4a71gla	cmmo3suxw0000p1np0eron6et	LOGIN	User	cmmo3suxw0000p1np0eron6et	::1	Connexion de admin@example.com	2026-05-01 22:05:39.8
cmorda41w0003abzgpzfyfhh5	cmmo3suxw0000p1np0eron6et	LOGIN	User	cmmo3suxw0000p1np0eron6et	::1	Connexion de admin@example.com	2026-05-04 15:41:19.749
cmorptiv6000310mct8ntbnwu	cmmo3suxw0000p1np0eron6et	LOGIN	User	cmmo3suxw0000p1np0eron6et	::1	Connexion de admin@example.com	2026-05-04 21:32:20.802
cmorpv4cp000m10mcr7b8rcms	cmmo3suxw0000p1np0eron6et	ADMIN_RESET_PASSWORD	User	cmolxu5bz0001hjp688nfthe4	::1	Mot de passe réinitialisé pour amina@yopmail.com	2026-05-04 21:33:35.305
cmorpveuj000q10mcaqia5qhw	cmolxu5bz0001hjp688nfthe4	LOGIN	User	cmolxu5bz0001hjp688nfthe4	::1	Connexion de amina@yopmail.com	2026-05-04 21:33:48.907
cmorpz5v2001310mcnef2wb0o	cmolxu5bz0001hjp688nfthe4	MISSION_CANCELLED	Mission	cmomwg3er000paov9jbu1euam	::1	Mission 1 MAI annulée	2026-05-04 21:36:43.887
cmorqed0z001710mca7hwrmeh	cmolxu5bz0001hjp688nfthe4	LOGIN	User	cmolxu5bz0001hjp688nfthe4	::1	Connexion de amina@yopmail.com	2026-05-04 21:48:33.011
cmorqfewv001b10mc65t94oah	cmmo3suxw0000p1np0eron6et	LOGIN	User	cmmo3suxw0000p1np0eron6et	::1	Connexion de admin@example.com	2026-05-04 21:49:22.111
cmorqhx6c001h10mcqn8tlmuw	cmolxu5bz0001hjp688nfthe4	LOGIN	User	cmolxu5bz0001hjp688nfthe4	::1	Connexion de amina@yopmail.com	2026-05-04 21:51:19.092
cmorqjyco001l10mcr8k3zs9n	cmmo3suxw0000p1np0eron6et	LOGIN	User	cmmo3suxw0000p1np0eron6et	::1	Connexion de admin@example.com	2026-05-04 21:52:53.929
cmorqlajh001x10mctrf4sgzn	cmolxu5bz0001hjp688nfthe4	LOGIN	User	cmolxu5bz0001hjp688nfthe4	::1	Connexion de amina@yopmail.com	2026-05-04 21:53:56.381
cmorqmnoc002o10mcigfxmpat	cmolxu5bz0001hjp688nfthe4	MISSION_CREATED	Mission	cmorqmicb002g10mcv1rng92w	::1	Mission TEST créée	2026-05-04 21:55:00.06
cmoskxmix000313h4vdtlaasg	cmmo3suxw0000p1np0eron6et	LOGIN	User	cmmo3suxw0000p1np0eron6et	::1	Connexion de admin@example.com	2026-05-05 12:03:20.265
cmoskznbv0001jzgzzabf24ma	cmmo3suxw0000p1np0eron6et	MEETING_REOPENED	Meeting	cmomwhv78000taov95p97cwo9	::1	Réunion "Presentation Projet" rouverte (statut SENT)	2026-05-05 12:04:54.619
\.
...
cmoslcnh80001x5sxm55ce49z	backup_2026-05-05T12-15-01.sql	backups\\backup_2026-05-05T12-15-01.sql	\N	PENDING	\N	MANUAL	2026-05-05 12:15:01.34	\N	cmmo3suxw0000p1np0eron6et
\.
...
cmorgwv990001o8wgksao8mjv	cmolxghbm0009rw4yvgj9oqff	2026-05-04 17:23:00.285	2026-05-04 17:23:00.285
\.
...
cmorgwva20002o8wgvimnde9h	cmorgwv990001o8wgksao8mjv	cmomtfazz0000jmo56gafwtru	2026-05-04 17:23:00.314
\.
...
cmorpu0ve000k10mc37o2nrpb	cmn9jawvp000aw1vtj8tfmc3y	cmmo3suxw0000p1np0eron6et	\N	2026-05-04 21:32:44.138	Proforma_S00002.pdf	/uploads/direction-messages/dir_cmmo3suxw0000p1np0eron6et_1777930364071.pdf	application/pdf	101920	\N
cmorpxiom001110mchjr3hari	cmolxghbk0008rw4yrddm0efv	cmolxu5bz0001hjp688nfthe4	sal	2026-05-04 21:35:27.19	\N	\N	\N	\N	\N
\.
...
cmomwhv78000taov95p97cwo9	Presentation Projet	Projet : GP	cmolxu5bz0001hjp688nfthe4	cmmo3sxne000ap1npvo2sif1m	2026-05-01 10:00:00.1	2026-05-05 12:34:54.603	SENT	\N	\N	2026-05-01 12:40:23.348	2026-05-05 12:04:54.606	\N	cmolxghax0000rw4yt5k984kg	cmn9jtuw6000tw1vtec7ayogn
\.
...
cmoskzwzl0003jzgzc904qdwh	cmomwhv78000taov95p97cwo9	cmmo3suxw0000p1np0eron6et	bnj	2026-05-05 12:05:07.136	\N
\.
...
cmomwg3er000paov9jbu1euam	1 MAI	Fête du travail	Dakar	2026-05-01 12:00:00.5	2026-05-02 12:00:00.5	cmolxu5bz0001hjp688nfthe4	CANCELLED	2026-05-01 12:39:00.676	2026-05-04 21:36:43.863	cmolxghbf0006rw4yer944plk	\N
cmorqmicb002g10mcv1rng92w	TEST	\N	TEST	2026-05-04 09:00:00.365	2026-05-04 12:00:00.365	cmolxu5bz0001hjp688nfthe4	CONFIRMED	2026-05-04 21:54:53.147	2026-05-04 21:54:53.147	cmolxghbh0007rw4yx7zf2yni	cmorqfxqn001d10mci9ucbryo
\.
...
cmorqmicl002h10mc7tbf0ja2	cmorqmicb002g10mcv1rng92w	cmmo3sw3o0003p1nppenw0vmn	2026-05-04 21:54:53.158
cmorqmicl002i10mciovx4ig3	cmorqmicb002g10mcv1rng92w	cmmo3swhb0004p1npbgv6f66x	2026-05-04 21:54:53.158
\.
...
cmorgwxre0007o8wgysipe2n6	cmomtfazz0000jmo56gafwtru	ROLE_CHANGED	Votre rôle a été modifié	Votre rôle est passé de "Administrateur" à "Secrétaire général".	/profile	f	2026-05-04 17:23:03.53
cmorql2fs001t10mckim07ayh	cmolxu5bz0001hjp688nfthe4	ROLE_CHANGED	Votre rôle a été modifié	Votre rôle est passé de "Consolidateur" à "Responsable".	/profile	f	2026-05-04 21:53:45.88
cmorqmlay002k10mc1t743x2t	cmmo3sw3o0003p1nppenw0vmn	MISSION_CREATED	Nouvelle mission assignée	Mission « TEST » le 04/05/2026 à TEST.	/missions/cmorqmicb002g10mcv1rng92w	f	2026-05-04 21:54:56.986
cmorqmnmi002m10mc4s4w19jy	cmmo3swhb0004p1npbgv6f66x	MISSION_CREATED	Nouvelle mission assignée	Mission « TEST » le 04/05/2026 à TEST.	/missions/cmorqmicb002g10mcv1rng92w	f	2026-05-04 21:54:59.994
\.
...
cmorqfxqn001d10mci9ucbryo	ccbmshop_prod	DP202	test projet	t	2026-05-04 21:49:46.512	2026-05-04 21:49:46.512	cmmo3suxw0000p1np0eron6et	ACTIVE
\.


--
-- Data for Name: ProjectDiscussion; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public."ProjectDiscussion" (id, "projectId", "createdAt", "updatedAt") FROM stdin;
cmorgwvae0004o8wg8vffb6mb	cmn9jtuw6000tw1vtec7ayogn	2026-05-04 17:23:00.326	2026-05-04 17:23:00.326
cmorqkzws001q10mc5klno5nw	cmorqfxqn001d10mci9ucbryo	2026-05-04 21:53:42.605	2026-05-04 21:53:42.605
\.


--
-- Data for Name: ProjectDiscussionMember; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public."ProjectDiscussionMember" (id, "discussionId", "userId", "joinedAt") FROM stdin;
cmorgwvaz0005o8wg72x3llg3	cmorgwvae0004o8wg8vffb6mb	cmomtfazz0000jmo56gafwtru	2026-05-04 17:23:00.348
cmorqkzx0001r10mc0ks4m6s2	cmorqkzws001q10mc5klno5nw	cmolxu5bz0001hjp688nfthe4	2026-05-04 21:53:42.613
\.
...
--
-- Data for Name: ProjectMessage; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public."ProjectMessage" (id, "projectId", "senderId", "parentId", body, "fileName", "fileUrl", "mimeType", size, "createdAt") FROM stdin;
cmorqlpn1002e10mcsqfw7taf	cmorqfxqn001d10mci9ucbryo	cmolxu5bz0001hjp688nfthe4	\N	TTT	\N	\N	\N	\N	2026-05-04 21:54:15.949
\.
...
cmon19c7d0001itqp6m2gpjag	cmmo3suxw0000p1np0eron6et	eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImNtbW8zc3V4dzAwMDBwMW5wMGVyb242ZXQiLCJpYXQiOjE3Nzc2NDcyMjMsImV4cCI6MTc3ODI1MjAyM30.giG0iAgV9E4EtebwaHJsrVOJLPBKtGoO_4VlXMn0LTM	2026-05-08 14:53:43.56	t	2026-05-01 14:53:43.561
cmongonsj00011vuogekqzsro	cmmo3suxw0000p1np0eron6et	eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImNtbW8zc3V4dzAwMDBwMW5wMGVyb242ZXQiLCJpYXQiOjE3Nzc2NzMxMzIsImV4cCI6MTc3ODI3NzkzMn0.8NtA185TYmZjiqrl4-AxC_irE8VrRpIcAaFTLDeQ3HY	2026-05-08 22:05:32.65	f	2026-05-01 22:05:32.652
cmongota200051vuo0ojezyw5	cmmo3suxw0000p1np0eron6et	eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImNtbW8zc3V4dzAwMDBwMW5wMGVyb242ZXQiLCJpYXQiOjE3Nzc2NzMxMzksImV4cCI6MTc3ODI3NzkzOX0.IsLoFeF5q8PPNizafsFN_ExQDKldWjneI61hUWcZJZA	2026-05-08 22:05:39.768	f	2026-05-01 22:05:39.77
cmorda41d0001abzgp1hxxmkm	cmmo3suxw0000p1np0eron6et	eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImNtbW8zc3V4dzAwMDBwMW5wMGVyb242ZXQiLCJpYXQiOjE3Nzc5MDkyNzksImV4cCI6MTc3ODUxNDA3OX0.gNJEWRdctq6FHtTnI7aDH1pDzlDZ93Gnywh_oSJZDME	2026-05-11 15:41:19.725	t	2026-05-04 15:41:19.729
...
cmorptiu0000110mc7m5exalf	cmmo3suxw0000p1np0eron6et	eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImNtbW8zc3V4dzAwMDBwMW5wMGVyb242ZXQiLCJpYXQiOjE3Nzc5MzAzNDAsImV4cCI6MTc3ODUzNTE0MH0.BpLuFmu5n7ux5DJhYAisBLVHEqVh8TpIex8qedPnG7w	2026-05-11 21:32:20.728	t	2026-05-04 21:32:20.732
cmorpvetk000o10mcswqn6e6n	cmolxu5bz0001hjp688nfthe4	eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImNtb2x4dTViejAwMDFoanA2ODhuZnRoZTQiLCJpYXQiOjE3Nzc5MzA0MjgsImV4cCI6MTc3ODUzNTIyOH0.q6lkVA70ZQUVeEjIqbaCUAvYFVrXMe6Rr8WOnwMI2gM	2026-05-11 21:33:48.871	t	2026-05-04 21:33:48.872
cmorqed00001510mca86aofxh	cmolxu5bz0001hjp688nfthe4	eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImNtb2x4dTViejAwMDFoanA2ODhuZnRoZTQiLCJpYXQiOjE3Nzc5MzEzMTIsImV4cCI6MTc3ODUzNjExMn0.C0dhg4GyPvlZf6GwP_c0giwuWxaGXyQ7A3wYi9eb4v8	2026-05-11 21:48:32.973	t	2026-05-04 21:48:32.977
cmorqfew0001910mccl92ojbw	cmmo3suxw0000p1np0eron6et	eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImNtbW8zc3V4dzAwMDBwMW5wMGVyb242ZXQiLCJpYXQiOjE3Nzc5MzEzNjIsImV4cCI6MTc3ODUzNjE2Mn0.joQQGkYpB905R0EaXIpPhv_uGZ7KzT02nny3MkVHyVM	2026-05-11 21:49:22.077	t	2026-05-04 21:49:22.08
cmorqhx5w001f10mcvzn7u0kn	cmolxu5bz0001hjp688nfthe4	eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImNtb2x4dTViejAwMDFoanA2ODhuZnRoZTQiLCJpYXQiOjE3Nzc5MzE0NzksImV4cCI6MTc3ODUzNjI3OX0.o8B9XILcjYiiTagPbTfIOk7970SdTop9nzXuxtuwb1o	2026-05-11 21:51:19.075	t	2026-05-04 21:51:19.076
cmorqjybs001j10mcyxuub3yo	cmmo3suxw0000p1np0eron6et	eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImNtbW8zc3V4dzAwMDBwMW5wMGVyb242ZXQiLCJpYXQiOjE3Nzc5MzE1NzMsImV4cCI6MTc3ODUzNjM3M30.nr0KtEsHB9f8Fk0zdlmU2cCwxmALSl3F3-SD7t2KL4I	2026-05-11 21:52:53.894	t	2026-05-04 21:52:53.897
cmorqlail001v10mcjgkj5cxu	cmolxu5bz0001hjp688nfthe4	eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImNtb2x4dTViejAwMDFoanA2ODhuZnRoZTQiLCJpYXQiOjE3Nzc5MzE2MzYsImV4cCI6MTc3ODUzNjQzNn0.60PRtwxUid8ffoV6-qqWJT7UgYr0HUbOlMv2f2e3CEQ	2026-05-11 21:53:56.349	f	2026-05-04 21:53:56.35
cmoskxmi7000113h4l7mz9ni7	cmmo3suxw0000p1np0eron6et	eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImNtbW8zc3V4dzAwMDBwMW5wMGVyb242ZXQiLCJpYXQiOjE3Nzc5ODI2MDAsImV4cCI6MTc3ODU4NzQwMH0.TGP_91fyS1ZInHWb5fgNOcPHU89-Hjs3-G38A-jUl1Q	2026-05-12 12:03:20.233	f	2026-05-05 12:03:20.234
\.
...
cmomwr3w8001daov9jlng7q5s	cmmo3sxne000ap1npvo2sif1m	cmomwhv78000taov95p97cwo9	cmolxu5bz0001hjp688nfthe4	2026-05-01 10:00:00.1	10:00	16:00	CANCELLED	2026-05-01 12:47:34.52
\.
...
COPY public."User" (id, name, email, "passwordHash", role, "isActive", "createdAt", "updatedAt", "avatarUrl", "isDeleted", "twoFactorEnabled", "twoFactorSecret", "directionId", "projectId", "cellUnit", "jobTitle", phone) FROM stdin;
cmmo3swu20005p1nphypodze0	Responsable 3	responsable3@example.com	$2b$12$zKw7Ib2TMndmAkmyr34zf.bc8gz1T8AA31qVvi.OaKLdciX690GxG	RESPONSABLE	t	2026-03-12 23:33:17.498	2026-03-12 23:33:17.498	\N	f	f	\N	\N	\N	\N	\N	\N
cmmo3sxa90006p1npcmnoc8dt	Responsable 4	responsable4@example.com	$2b$12$mfRGKGV2beUTKSj3BiuARuu/P/EYyXNzUv2fFzkr2Duzs7jpVmr5i	RESPONSABLE	t	2026-03-12 23:33:18.081	2026-03-12 23:33:18.081	\N	f	f	\N	\N	\N	\N	\N	\N
cmmot9cwj00008jo77uui1yor	Amina KHOUMA	alhusseinkhouma0@gmail.com	$2b$12$fb2rD8j./AZWoMXxWRy3xeKeODBPCh5qabXpNtxRYAfO.CjSCzCRW	RESPONSABLE	t	2026-03-13 11:25:55.219	2026-05-01 12:49:45.427	/uploads/avatars/cmmot9cwj00008jo77uui1yor.png	f	f	\N	cmn9jawvp000aw1vtj8tfmc3y	\N	\N	\N	\N
cmmo3sxn00007p1npldvr5svn	Responsable 5	responsable5@example.com	$2b$12$b2UM1aqaBuw85bVNpik4WObGPKKo7hc5SsOsnMThCaekfFuzN7zQq	RESPONSABLE	t	2026-03-12 23:33:18.54	2026-05-01 12:50:12.481	\N	f	f	\N	\N	\N	\N	\N	\N
cmmo3sw3o0003p1nppenw0vmn	Responsable 1	responsable1@example.com	$2b$12$ct2eztYLzJyqd7m0cvDbJuU3eTPT5fUWfK8tVl8bC3yKImv/WRFJi	RESPONSABLE	t	2026-03-12 23:33:16.549	2026-03-26 14:45:15.574	/uploads/avatars/cmmo3sw3o0003p1nppenw0vmn.png	f	t	KFKFQYZSGA4EOR26O4XVIYKFI54WO5KJ	\N	\N	\N	\N	\N
cmmo3swhb0004p1npbgv6f66x	Responsable 2	responsable2@example.com	$2b$12$ldoTtJ7PO3rRyBBum.8Vcuc.ivy6p5XdNchKyX/YE/LzDgPo4lTQC	RESPONSABLE	t	2026-03-12 23:33:17.039	2026-03-31 07:50:17.127	\N	f	f	\N	\N	\N	\N	\N	\N
cmmo3svdj0001p1npkybbwako	Mansour BOCOUM	mansour.bocoum@example.com	$2b$12$ZKhR9qNs52bXSZIFgtvn0u4bIv762UyeNjUV1eugf0PHGtFABykrK	CONSOLIDATEUR	t	2026-03-12 23:33:15.607	2026-03-31 08:34:11.273	\N	f	f	\N	\N	\N	\N	\N	\N
cmmo3svr60002p1npg39ix3rb	Directeur General	dg@example.com	$2b$12$fL1WsfVQ5Egnnbsrq/3.kOMAGaNg14mP5tgTJLbeOmirXMaUVg6yi	DG	t	2026-03-12 23:33:16.098	2026-03-31 12:28:17.468	\N	f	f	\N	cmn9jawvp000aw1vtj8tfmc3y	\N	\N	\N	\N
cmmo3suxw0000p1np0eron6et	Admin User	admin@example.com	$2b$12$jHepMaNovs1n.pJ31KR9HefO5W7ltn3e/VuyaTIgl6yElwalVy7rC	SUPER_ADMIN	t	2026-03-12 23:33:15.042	2026-05-01 22:05:26.867	/uploads/avatars/cmmo3suxw0000p1np0eron6et.webp	f	f	OZVXOODBGJIDY2CTJYYTGQS5KE4EA3L3	cmn9jawvp000aw1vtj8tfmc3y	\N	\N	\N	\N
cmomtfazz0000jmo56gafwtru	SG	sg@adm.com	$2b$10$tZP5mmy/iA3Kz7XEqm45/ed5H0QY5pMZzI..jgAKroYSkn3BBih/6	SECRETAIRE_GENERAL	t	2026-05-01 11:14:24.979	2026-05-04 17:23:00.219	\N	f	f	\N	cmolxghbm0009rw4yvgj9oqff	cmn9jtuw6000tw1vtec7ayogn	\N	\N	\N
cmolxu5bz0001hjp688nfthe4	Aminata	amina@yopmail.com	$2b$12$DZr1Zf6WTLS4Menj3zwpN.wSIhm7tQEY1ojWWpgjSPmr3oPV6ZXsq	RESPONSABLE	t	2026-04-30 20:30:09.792	2026-05-04 21:53:42.586	/uploads/avatars/cmolxu5bz0001hjp688nfthe4.png	f	f	\N	cmolxghbk0008rw4yrddm0efv	cmorqfxqn001d10mci9ucbryo	\N	\N	\N
\.
...
--
-- Name: ProjectDiscussionMember ProjectDiscussionMember_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."ProjectDiscussionMember"
    ADD CONSTRAINT "ProjectDiscussionMember_pkey" PRIMARY KEY (id);


--
-- Name: ProjectDiscussion ProjectDiscussion_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."ProjectDiscussion"
    ADD CONSTRAINT "ProjectDiscussion_pkey" PRIMARY KEY (id);
...
--
-- Name: ProjectMessage ProjectMessage_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."ProjectMessage"
    ADD CONSTRAINT "ProjectMessage_pkey" PRIMARY KEY (id);
...
--
-- Name: ProjectDiscussionMember_discussionId_userId_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "ProjectDiscussionMember_discussionId_userId_key" ON public."ProjectDiscussionMember" USING btree ("discussionId", "userId");


--
-- Name: ProjectDiscussionMember_userId_joinedAt_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "ProjectDiscussionMember_userId_joinedAt_idx" ON public."ProjectDiscussionMember" USING btree ("userId", "joinedAt");


--
-- Name: ProjectDiscussion_projectId_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "ProjectDiscussion_projectId_key" ON public."ProjectDiscussion" USING btree ("projectId");
...
--
-- Name: ProjectMessage_parentId_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "ProjectMessage_parentId_idx" ON public."ProjectMessage" USING btree ("parentId");


--
-- Name: ProjectMessage_projectId_createdAt_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "ProjectMessage_projectId_createdAt_idx" ON public."ProjectMessage" USING btree ("projectId", "createdAt");


--
-- Name: ProjectMessage_senderId_createdAt_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "ProjectMessage_senderId_createdAt_idx" ON public."ProjectMessage" USING btree ("senderId", "createdAt");
...
--
-- Name: User_projectId_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "User_projectId_idx" ON public."User" USING btree ("projectId");
...
--
-- Name: ProjectDiscussionMember ProjectDiscussionMember_discussionId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."ProjectDiscussionMember"
    ADD CONSTRAINT "ProjectDiscussionMember_discussionId_fkey" FOREIGN KEY ("discussionId") REFERENCES public."ProjectDiscussion"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: ProjectDiscussionMember ProjectDiscussionMember_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."ProjectDiscussionMember"
    ADD CONSTRAINT "ProjectDiscussionMember_userId_fkey" FOREIGN KEY ("userId") REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: ProjectDiscussion ProjectDiscussion_projectId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."ProjectDiscussion"
    ADD CONSTRAINT "ProjectDiscussion_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES public."Project"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: ProjectMessage ProjectMessage_parentId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."ProjectMessage"
    ADD CONSTRAINT "ProjectMessage_parentId_fkey" FOREIGN KEY ("parentId") REFERENCES public."ProjectMessage"(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: ProjectMessage ProjectMessage_projectId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."ProjectMessage"
    ADD CONSTRAINT "ProjectMessage_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES public."Project"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: ProjectMessage ProjectMessage_senderId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."ProjectMessage"
    ADD CONSTRAINT "ProjectMessage_senderId_fkey" FOREIGN KEY ("senderId") REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: User User_projectId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
\unrestrict D6ufcIhVL2rrn6atSYXw3osdCCuEv2Ph60OpSy34JTPmSutAKcPa0Sacq7TmZTv
