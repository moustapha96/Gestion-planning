    ...
    return (
        <div>
            <Alert
                ...
                showIcon
                icon={<AppleOutlined />}
                style={{ marginBottom: 16, borderColor: '#1565C0' }}
            />
            <Steps
                direction="vertical"
                size="small"
                items={[
                    {
                        ...
                        icon: <div style={{ background: '#1565C0', borderRadius: '50%', width: 24, height: 24, display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: 12 }}>1</div>,
                    },
                    {
                        ...
                        icon: <div style={{ background: '#1565C0', borderRadius: '50%', width: 24, height: 24, display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: 12 }}>2</div>,
                    },
                    {
                        ...
                        icon: <div style={{ background: '#1565C0', borderRadius: '50%', width: 24, height: 24, display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: 12 }}>3</div>,
                    },
                    {
